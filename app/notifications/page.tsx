    ...
    <div className="container mx-auto px-6 py-8 max-w-3xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Aggiornamenti su ordini, prodotti e novità</p>
        </div>
      </div>
      ...
      {notifications.length === 0 ? (
        <div className="bg-white border rounded-xl p-12 text-center">
          ...
          <p className="text-gray-600 font-semibold mb-1">Nessuna notifica</p>
          <p className="text-sm text-gray-400">Quando ci saranno aggiornamenti, li vedrai qui.</p>
        </div>
      ) : (
                ...
                <div className="flex items-start gap-3 p-4 hover:bg-gray-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-baseline justify-between gap-2 mb-1">
                      <h3 className={`font-semibold ${n.is_read ? 'text-gray-700' : 'text-gray-900'}`}>
                        {n.title}
                      </h3>
