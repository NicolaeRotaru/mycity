  ...
  return (
    <div className="container mx-auto px-6 py-10 max-w-3xl">
      <div className="mb-8 text-center">
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3">↩️ Resi e rimborsi</h1>
        <p className="text-gray-600">Hai 14 giorni di tempo per ripensarci. Ecco come funziona.</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-2xl p-6 mb-10">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="font-bold text-gray-900 mb-1">14 giorni di diritto di recesso</h2>
      ...
      <section className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-3">Come restituire un prodotto</h2>
          <ol className="list-decimal pl-5 space-y-2">
            <li>Vai su <Link href="/orders" className="text-indigo-600 underline">"I miei ordini"</Link> e apri l'ordine interessato.</li>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Condizioni del prodotto restituito</h2>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Tempi e modalità di rimborso</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Chi paga la spedizione del reso?</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Garanzia legale di conformità</h2>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Hai bisogno di aiuto?</h2>
          ...
          <div className="flex gap-3 flex-wrap mt-3">
            <Link href="/contact" className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-lg font-semibold transition-colors">
              ✉️ Contatta supporto
            </Link>
            <Link href="/faq" className="inline-block bg-gray-100 hover:bg-gray-200 text-gray-900 px-5 py-2.5 rounded-lg font-semibold transition-colors">
              📖 Vai alle FAQ
            </Link>
          </div>
        </div>
