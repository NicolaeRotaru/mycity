  ...
  return (
    <div className="container mx-auto px-6 py-10 max-w-3xl">
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed">
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-2">1. Cosa sono i cookie</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-2">2. Tipologie di cookie usati</h2>

          <h3 className="font-semibold text-gray-900 mt-4 mb-2">2.1 Cookie tecnici (sempre attivi)</h3>
          <p>
          ...
          <h3 className="font-semibold text-gray-900 mt-4 mb-2">2.2 Cookie funzionali (richiede consenso)</h3>
          ...
          <h3 className="font-semibold text-gray-900 mt-4 mb-2">2.3 Cookie di analisi (richiede consenso)</h3>
          <p>
          ...
          <h3 className="font-semibold text-gray-900 mt-4 mb-2">2.4 Cookie di marketing (richiede consenso)</h3>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-2">3. Come gestire le preferenze</h2>
          <p>
          ...
          <button
            ...
            className="mt-2 inline-flex rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700"
          >
            🍪 Apri preferenze cookie
          </button>
          <p className="mt-3 text-sm">
            In alternativa puoi disabilitare i cookie dalle impostazioni del browser:
            {' '}<a className="text-indigo-600 underline" href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer">Chrome</a>,
            {' '}<a className="text-indigo-600 underline" href="https://support.mozilla.org/it/kb/Attivare%20e%20disattivare%20i%20cookie" target="_blank" rel="noopener noreferrer">Firefox</a>,
            {' '}<a className="text-indigo-600 underline" href="https://support.apple.com/it-it/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer">Safari</a>,
            {' '}<a className="text-indigo-600 underline" href="https://support.microsoft.com/it-it/microsoft-edge/eliminare-i-cookie-in-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer">Edge</a>.
          </p>
          <p className="text-sm">
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-2">4. Trasferimenti extra-UE</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-900 mb-2">5. Aggiornamenti</h2>
          <p>
        ...
        <section>
          <p className="text-sm">
            ...
            <Link href="/privacy" className="text-indigo-600 underline">Informativa sulla privacy</Link>.
          </p>
        </section>
      </div>
