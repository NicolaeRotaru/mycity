  ...
  return (
    <div className="container mx-auto px-6 py-10 max-w-3xl">
      <div className="mb-8 text-center">
        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-3">🚚 Spedizioni e consegne</h1>
        <p className="text-gray-600">Tempi, costi e opzioni per ricevere il tuo ordine.</p>
      </div>
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-10">
        <div className="bg-green-50 border border-green-200 rounded-xl p-5 text-center">
          ...
          <div className="text-sm text-green-700 mt-1">Per ordini ≥ €30 dallo stesso venditore</div>
        </div>
        <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-5 text-center">
          <div className="text-3xl mb-2">⚡</div>
          <div className="font-bold text-indigo-900">Consegna 24-48h</div>
          <div className="text-sm text-indigo-700 mt-1">Nei comuni serviti</div>
        </div>
        <div className="bg-purple-50 border border-purple-200 rounded-xl p-5 text-center">
          <div className="text-3xl mb-2">🏪</div>
          <div className="font-bold text-purple-900">Ritiro in negozio</div>
          <div className="text-sm text-purple-700 mt-1">10% di sconto sull'ordine</div>
        </div>
      </div>

      <section className="prose prose-gray max-w-none space-y-6 text-gray-700 leading-relaxed">
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Tempi di consegna</h2>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Costi di spedizione</h2>
            ...
            <table className="w-full text-sm border-collapse">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="border p-2 text-green-700 font-semibold">GRATIS</td>
                </tr>
                <tr>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Ritiro in negozio</h2>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Tracciamento</h2>
          <p>Da <Link href="/orders" className="text-indigo-600 underline">"I miei ordini"</Link> vedi in tempo reale:</p>
          <ul className="list-disc pl-5">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Aree servite</h2>
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">Problemi con la consegna?</h2>
          <p>Se la consegna è in ritardo, il pacco è danneggiato o non arrivato, contatta il nostro supporto entro 48h:
          <Link href="/contact" className="text-indigo-600 underline ml-1">vai ai contatti</Link>.</p>
        </div>
      </section>
    </div>
  );
